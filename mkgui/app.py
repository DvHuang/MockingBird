...
# Constants
AUDIO_SAMPLES_DIR = '/data/samples/'
SYN_MODELS_DIRT = "/data/synthesizer/saved_models"
ENC_MODELS_DIRT = "/data/encoder/saved_models"
VOC_MODELS_DIRT = "/data/vocoder/saved_models"
TEMP_SOURCE_AUDIO = "/data/wavs/temp_source.wav"
TEMP_RESULT_AUDIO = "/data/wavs/temp_result.wav"
